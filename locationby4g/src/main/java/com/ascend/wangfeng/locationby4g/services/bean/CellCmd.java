...
public class CellCmd {
    ...
    public static String setCellScanREQ() {
        return CellCmd.build(1)
                .addBodyInt(460, 2)
                .addBodyInt(0)
                .addBodyInt(0)
                .addBodyInt(0).toString();
    }
    ...
    public static String setSwitchEnableReq(int type) {
        return CellCmd.build(77).addBodyInt(1).addBodyInt(type).toString();
    }
/*--------以上为编辑好的命令------------*/
